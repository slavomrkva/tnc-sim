/* i18n-about-de.js — web-only German override of openAboutPopup() (core/theme-toast.js).
...
(function () {
  ...
  window.openAboutPopup = function () {
    ...
    overlay.innerHTML = '<div style="background:var(--surface2);border-radius:14px;width:100%;max-width:420px;max-height:80vh;overflow-y:auto;box-shadow:0 8px 32px rgba(0,0,0,.5);">'
      ...
      +'<a id="aboutGuideLink" href="/de/learn/" style="flex:1 1 100%;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 10px;font-size:11px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text2);text-decoration:none;">Klartext-Anleitung</a>'
      +'<a href="/de/examples/" style="flex:1 1 100%;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 10px;font-size:11px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text2);text-decoration:none;">Korrigierte Programme aus Fehlermeldungen</a>'
