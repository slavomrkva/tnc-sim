// theme-toast -- web copy. Diverges from Android only in the About popup, where
// "Buy me a coffee" is a small unobtrusive text link rather than a full button.
...
function openAboutPopup(){
  ...
  overlay.innerHTML = '<div style="background:var(--surface2);border-radius:14px;width:100%;max-width:420px;max-height:80vh;overflow-y:auto;box-shadow:0 8px 32px rgba(0,0,0,.5);">'
    ...
    +'<a id="aboutGuideLink" href="/learn/" style="flex:1 1 100%;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 10px;font-size:11px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text2);text-decoration:none;">Klartext Guide</a>'
    +'<a href="/examples/" style="flex:1 1 100%;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 10px;font-size:11px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text2);text-decoration:none;">Corrected programs from bug reports</a>'
    ...
    +'<a href="https://buymeacoffee.com/slavozett" target="_blank" style="flex:1 1 100%;text-align:center;padding:2px 4px;font-size:10px;color:var(--text3);text-decoration:none;">\u2615 Buy me a coffee</a>'
