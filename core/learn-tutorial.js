...
function learnSvgPracticeHelpers(){
  return '<svg class="learn-svg" viewBox="0 0 340 150" role="img" aria-label="Practice helpers: goals, hints and check">'
    ...
    + '<text x="58" y="72" text-anchor="middle" font-family="monospace" font-size="9.5" fill="var(--text3)">what counts</text>'
    + '<text x="58" y="93" text-anchor="middle" font-family="monospace" font-size="9.5" fill="var(--text3)">grey before</text>'
    + '<text x="58" y="113" text-anchor="middle" font-family="monospace" font-size="9.5" fill="#5dcaa5">green after Check</text>'
