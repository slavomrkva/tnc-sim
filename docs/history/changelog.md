...
- Announced the new 15-lesson guide in English and German and advanced the
  offline cache to v101 for the production deploy.
...
- Restored `APP_VERSION` to 0.930 after the product decision to keep this
  footer refinement in the existing version. The approved styling and offline
  cache v95 remain unchanged.

## v0.930 — 2026-07-30 — neutral footer links and Play icon
...
- Replaced the arbitrary 500 mm box/cylinder rejection with one shared,
  ...
  are now guaranteed to remain inside the web 24M/64M memory budgets.
